...
export default function Card({ nftItem }) {
  return (
      ...
      <View style={Styles.bottomContainer}>
        <View style={Styles.bottomTop}>
          ...
          <View style={Styles.leftBox}>
            <CustomText style={Styles.leftBoxTitle}>Ending in</CustomText>
        ...
        <View style={Styles.textContainer}>
          ...
          <CustomText style={Styles.subTitle}>by {nftItem.creator}</CustomText>
        </View>
